...
USER_MESSAGE = "Hi, what are the highest rated movies among teenagers?"
...
if __name__ == '__main__':
    ...
    database_schema_string = database_schema.get_db_schema(conn)

print(f"Database schema string: \n{database_schema_string}")
